...
- Accountable value flow and treasury discipline  
- Institutional trust without centralization  
...
│   ├── governance.md        # Governance constitution
│   ├── monetization.md      # Sustainability & earning model
│   ├── badges.md            # Trust signal definitions
│   └── roadmap.md           # Planned milestones
│
├── people/                  # Identity & role system
├── contribution/            # Contribution & proposal logic
├── accountability/          # Escalation & authority
├── audit/                   # Compliance & audit logic
├── value-flow/              # Treasury & reward governance
│
...
TEOS Forge is governed by an explicit constitution.

- Roles, permissions, and escalation paths are defined in advance  
- Governance changes require documented proposals and review  
